...
SECRET_KEY = os.getenv("JWT_SECRET", "bambu-filament-win-jwt-secret-key-1.2.3")
ALGORITHM = "HS256"
...
app = FastAPI(
    title="丝管 3D 打印耗材资产管理系统 - Windows 服务端", 
    version="1.2.3",
    docs_url="/api/docs",
    redoc_url=None
)
...
def read_index():
    ...
    return {"status": "success", "message": "丝管耗材管理服务端 (Windows SQLite v1.2.3) 运行正常"}
...
if __name__ == "__main__":
    # Windows 控制台编码修复：强制 UTF-8 输出（避免 emoji/中文打印 GBK 报错）
    try:
    ...
    print("=" * 72)
    print("      丝管 3D 打印耗材资产管理系统 - Windows 服务端 v1.2.3")
    print("=" * 72)
